...
// !!! Modifications by Debashish Buragohain here !!!
//for the modifications to suit our purpose
let devMod = true;              //if we are in the development mode or not
declare var rmsValue: number;   //defining a global rmsValue variable
declare var currentExpression : string;
let prevExpression = "";      //we store both the previous and current expression
...
export class LAppModel extends CubismUserModel {
  ...
  public update(): void {
    ...
    if (this._lipsync) {
      for (let i = 0; i < this._lipSyncIds.getSize(); ++i) {
        this._model.addParameterValueById(this._lipSyncIds.at(i), rmsValue, 0.8);
      }
    }
  ...
  public startMotion(
    ...
    console.log("Exp: Started motion: ", motionFileName)
    // ex) idle_0
  ...
  public setExpression(expressionId: string): void {
    ...
    console.log("Chosen expression: ", expressionId)
    if (this._debugMode) {
